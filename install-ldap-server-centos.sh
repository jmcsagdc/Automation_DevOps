...
perl -pi -e 's|\x2F\x2F \x24servers\x2D\x3EsetValue\x28\x27login\x27,\x27bind_id\x27,\x27\x27\x29\x3B|\x24servers\x2D\x3EsetValue\x28\x27login\x27,\x27bind_id\x27,\x27cn\x3Dldapadmin,dc\x3Djmcsagdc,dc\x3Dlocal\x27\x29\x3B|g' /etc/phpldapadmin/config.php
